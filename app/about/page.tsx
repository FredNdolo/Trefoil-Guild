        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 lg:px-8 py-20 md:py-28">
          <div className="max-w-2xl animate-fade-up">
            ...
            <h1 className="font-800 text-[clamp(40px,6vw,72px)] text-white leading-tight mb-5 tracking-tight">
              Inspiring <span className="text-gold">Generations,</span>
        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            ...
            <RevealWrapper>
              ...
              <h2 className="font-800 text-[clamp(28px,3.5vw,44px)] text-deep-blue leading-tight mt-3 mb-6">
                Who We Are
              </h2>
              ...
              <div className="inline-flex items-center gap-3 bg-sky-light border border-sky-blue/20 rounded-xl px-5 py-3">
                ...
                <div>
                  <div className="text-deep-blue font-700 text-[13px]">WAGGGS Affiliated</div>
            ...
            <RevealWrapper delay={150}>
              <div className="bg-deep-blue rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-white font-800 text-[26px] leading-tight mb-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      ...
                      <div key={item.key}>
                        ...
                        <div className="text-white/40 text-[10px] font-600 tracking-wider uppercase mt-1">{item.key}</div>
                      </div>
                    ))}
                  </div>
                  <div className="mt-6 rounded-xl overflow-hidden aspect-[16/9]">
                    <Image
                      src="/trefoil-logo.jpg"
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <RevealWrapper delay={150}>
              ...
              <p className="text-text-muted leading-relaxed mb-5">
                These women live primarily in informal settlements like <strong className="text-deep-blue">Kibra in Nairobi</strong>,
              ...
              <div className="bg-white rounded-xl p-5 border border-border-soft mb-5">
                <p className="text-deep-blue font-700 text-[13px] mb-3">This project aims to empower grandmothers who:</p>
              ...
              <Link
                href="/programme"
                className="inline-flex items-center gap-2 bg-deep-blue hover:bg-mid-blue text-white font-600 text-[13px] px-6 py-3 rounded-md transition-colors"
              >
                See Our Programme
            ...
            {VALUES.map((v, i) => (
              <RevealWrapper key={v.title} delay={i * 80}>
                <div className="bg-sky-light rounded-xl p-6 border border-sky-blue/10 hover:border-sky-blue/30 hover:shadow-card transition-all duration-300 group">
                  ...
                  <h3 className="font-700 text-[16px] text-deep-blue mb-2 group-hover:text-sky-blue transition-colors">
                    {v.title}
                  </h3>
          ...
          <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 items-center">
            ...
            <RevealWrapper>
              ...
              <h2 className="font-800 text-[clamp(28px,3.5vw,44px)] text-white mt-3 mb-5 leading-tight">
                United Nations
                <br />
                <span className="text-gold">Sustainable Development Goals</span>
              </h2>
            ...
            <div className="grid grid-cols-3 gap-3">
              {SDGS.map((sdg, i) => (
                <RevealWrapper key={sdg.num} delay={i * 80}>
                  <div className="bg-white/[0.06] border border-sky-blue/15 rounded-xl p-4 text-center hover:bg-white/[0.1] hover:border-gold/30 transition-all duration-200">
                    <div className="font-800 text-[32px] text-gold leading-none mb-1">
                      {sdg.num}
                    </div>
                    <div className="text-white/60 text-[11px] font-600 tracking-wide leading-tight">
                      {sdg.label}
                    </div>
                  </div>
                </RevealWrapper>
                  ...
                  <div className={`relative flex gap-6 md:gap-0 ${i % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                    <div className={`flex-1 pl-12 md:pl-0 ${i % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12'}`}>
                      <div className="bg-sky-light border border-sky-blue/15 rounded-xl p-5 hover:shadow-card transition-shadow duration-300">
                        ...
                        <h3 className="font-700 text-[16px] text-deep-blue mt-1 mb-2">{item.title}</h3>
      ...
      <section className="section-pad bg-sky-blue relative overflow-hidden">
        ...
        <div className="container-tight relative z-10 text-center">
          <RevealWrapper>
            ...
            <h2 className="font-800 text-[clamp(26px,4vw,42px)] text-deep-blue mb-5 leading-tight">
