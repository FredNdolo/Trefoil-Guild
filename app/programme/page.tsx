      ...
      <section className="bg-deep-blue relative overflow-hidden pt-[68px]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 lg:px-8 py-20 md:py-28">
          <div className="max-w-2xl animate-fade-up">
            ...
            <p className="text-dark-navy/70 text-[17px] font-300 leading-relaxed max-w-xl">
        ...
        <div className="relative z-10 border-t border-white/10">
          <div className="max-w-6xl mx-auto px-5 lg:px-8 py-3 flex items-center gap-2 text-[12px] text-dark-navy/40">
            ...
            <span>/</span>
            <span className="text-dark-navy/60">Programme</span>
          </div>
        </div>
      </section>
        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 items-center">
            ...
            <RevealWrapper>
              ...
              <h2 className="font-800 text-[clamp(26px,3.5vw,42px)] text-dark-navy leading-tight mt-3 mb-5">
              ...
              <div className="bg-sky-light border-l-4 border-sky-blue rounded-r-xl p-5 mb-5">
                <p className="text-dark-navy font-500 text-[15px] leading-relaxed italic">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={s.label} className="bg-sky-light rounded-xl p-5 border border-sky-blue/15">
                    <div className="font-800 text-[28px] text-dark-navy leading-none mb-1.5">{s.num}</div>
              ...
              <RevealWrapper key={act.id} delay={80}>
                ...
                >
                  <div className={`relative aspect-[4/3] lg:aspect-auto bg-sky-light ${i % 2 !== 0 ? 'lg:order-2' : ''}`}>
                    ...
                    />
                    <div className="absolute top-4 left-4 w-10 h-10 rounded-full bg-dark-navy/80 backdrop-blur-sm flex items-center justify-center">
                      <span className="text-gold font-800 text-[13px]">{act.num}</span>
                    </div>
                    {act.isNew && (
                      <div className="absolute top-4 right-4 bg-gold text-dark-navy text-[10px] font-800 tracking-wider uppercase px-2.5 py-1 rounded-full">
                        New 2025–26
                      </div>
                    )}
                  </div>
                  ...
                  <div className={`p-7 md:p-8 flex flex-col justify-center ${i % 2 !== 0 ? 'lg:order-1' : ''}`}>
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="font-800 text-[20px] text-dark-navy">{act.title}</h3>
                    </div>
                    ...
                    <div className="border-t border-border-soft pt-5">
                      <p className="text-dark-navy font-700 text-[12px] tracking-wider uppercase mb-3">
                        Key Highlights
                      </p>
        ...
        <div className="container-wide relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <RevealWrapper>
              ...
              <h2 className="font-800 text-[clamp(28px,3.5vw,44px)] text-dark-navy mt-3 leading-tight">
                New Techniques
                <br />
            ...
            <RevealWrapper delay={100}>
              <p className="text-dark-navy/70 text-[14px] leading-relaxed max-w-sm">
        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <RevealWrapper>
              ...
              <h2 className="font-800 text-[clamp(26px,3.5vw,42px)] text-dark-navy mt-3 mb-5 leading-tight">
                Where We Are
                <br />
                ...
                {[
                  ...
                  <div key={item.challenge} className="bg-sky-light rounded-xl p-4 border border-sky-blue/10">
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <p className="text-dark-navy text-[13px] font-600">{item.challenge}</p>
                    </div>
