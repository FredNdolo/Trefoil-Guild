...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: 'Beadwork',
    price: 500,
    image: '/Kenya-shanga.jpg',
    images: ['/Kenya-shanga.jpg'],
    description: 'Kenyan Flag Bracelet. Pretty, and sustainably made — a great everyday gift.',
    details: ['Kenyan Flag', 'Beaded'],
    inStock: true,
    rating: 4.6,
    reviewCount: 14,
  },
  {
    id: 17,
    name: 'Green and Black knit bag',
    category: 'Knitwork',
    price: 1500,
    image: '/green-bag.jpg',
    images: ['/green-bag.jpg'],
    description: 'Green and Black knit bag. Pretty, and sustainably made — a great everyday gift.',
    details: ['Green and Black', 'Knit'],
    inStock: true,
    rating: 4.6,
    reviewCount: 14,
  },
  {
    id: 18,
    name: 'Multicolor Red pattern Knit bag',
    category: 'Knitwork',
    price: 1500,
    image: '/red-bag.jpg',
    images: ['/red-bag.jpg'],
    description: 'Multicolor Red pattern Knit bag. Pretty, and sustainably made — a great everyday gift.',
    details: ['Multicolor Red pattern', 'Knit'],
    inStock: true,
    rating: 4.6,
    reviewCount: 14,
  },
  {
    id: 19,
    name: 'Sisal Table Mat',
    category: 'Patchwork',
    price: 500,
    image: '/sisal-tablemat.jpg',
    images: ['/sisal-tablemat.jpg'],
    description: 'Sisal Table Mat. Pretty, and sustainably made — a great everyday gift.',
    details: ['Sisal Table Mat', 'Patchwork'],
    inStock: true,
    rating: 4.0,
    reviewCount: 9,
  },
  {
    ...
    image: '/sisal.jpg',
    images: ['/sisal.jpg'],
    description: 'Sisal Mat. Pretty, and sustainably made — a great everyday gift.',
    details: ['Sisal Mat', 'Sisal'],
    inStock: true,
    rating: 4.0,
    reviewCount: 9,
  },
  {
    ...
    category: 'Accessories',
    price: 800,
    image: '/tissue-holder.jpg',
    images: ['/tissue-holder.jpg'],
    description: 'Tissue-holder. Pretty, and sustainably made — a great everyday gift.',
    details: ['Tissue-holder', 'Handmade'],
    inStock: true,
    rating: 4.0,
    reviewCount: 9,
  },
  {
    id: 22,
    name: 'Orange Floor Mat',
    category: 'Patchwork',
    price: 1000,
    image: '/orange-mat.jpg',
    images: ['/orange-mat.jpg'],
    description: 'Orange Floor Mat. Pretty, and sustainably made — a great everyday gift.',
    details: ['Orange Floor Mat', 'Patchwork'],
    inStock: true,
    rating: 4.0,
    reviewCount: 9,
  },
  {
    id: 23,
    name: 'Red Kniited Poncho',
    category: 'Knitwork',
    price: 1500,
    image: '/red-poncho.jpg',
    images: ['/red-poncho.jpg'],
    description: 'Red Knited Poncho. Pretty, and sustainably made — a great everyday gift.',
    details: ['Red Knited Poncho', 'Knit'],
    inStock: true,
    rating: 4.0,
    reviewCount: 9,
  },
...
export const CATEGORIES: Category[] = ['All', 'Beadwork', 'Baskets', 'Patchwork', 'Accessories', 'Knitwork']
